...
function styles () {
    return src(['node_modules/@fancyapps/ui/dist/fancybox/fancybox.css', 'node_modules/slick-slider/slick/slick.css', 'node_modules/aos/dist/aos.css', path.src.css], {base: srcPath + 'scss/'})
    .pipe(plumber({
...
function scripts () {
    return src(['node_modules/jquery/dist/jquery.js', 'node_modules/@fancyapps/ui/dist/fancybox/fancybox.umd.js', 'node_modules/slick-slider/slick/slick.js', 'node_modules/aos/dist/aos.js', 'node_modules/mixitup/dist/mixitup.min.js',  path.src.js], {base: srcPath + 'js/'})
    .pipe(plumber({
      errorHandler : function (err) {
        notify.onError({
          title: "JS Error",
